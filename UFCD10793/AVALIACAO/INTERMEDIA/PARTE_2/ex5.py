...
caminho = 'c:/FORMACAO/fundamentosPython/UFCD10793/AVALIACAO/INTERMEDIA/PARTE_2/'
ficheiro_origem = 'exemplo.bin'
...
copiar_ficheiro_binario(caminho + ficheiro_origem, caminho + ficheiro_destino)